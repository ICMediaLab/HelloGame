...
public class EFXEffectRingModulator extends EFXEffect {
	...
	/** Returns the frequency of the ring modulator.
	 * @return The float value of the frequency
	 */
	public float getFrequency() {
		return getEffectf(EFX10.AL_RING_MODULATOR_FREQUENCY);
	}
	
	/** Returns the high-pass cutoff for the ring modulator.
	 * @return The float value of the high-pass cutoff
	 */
	public float getHighPassCutoff() {
		return getEffectf(EFX10.AL_RING_MODULATOR_HIGHPASS_CUTOFF);
	}
	
	/** Returns the waveform of the ring modulator.
	 * @return Should be EFXEffectRingModulator.SINUSOID, SAWTOOTH or SQUARE
	 */
	public int getWaveform() {
		return getEffecti(EFX10.AL_RING_MODULATOR_WAVEFORM);
	}
}