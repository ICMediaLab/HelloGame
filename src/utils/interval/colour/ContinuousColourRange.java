 ...
 */
public class ContinuousColourRange implements ColourRange {
	 ...
	 */
	public ContinuousColourRange(Interval r, Interval g, Interval b, Interval a) {
		this.r = r;
		this.g = g;
		this.b = b;
		this.a = a;
	 ...
	 */
	public ContinuousColourRange(Interval r, Interval g, Interval b) {
	 ...
	 */
	private ContinuousColourRange(float minr, float maxr, float ming, float maxg, float minb, float maxb, Interval a){
		this(
	 ...
	 */
	public ContinuousColourRange(float minr, float maxr, float ming, float maxg, float minb, float maxb, float mina, float maxa) {
	 ...
	 */
	public ContinuousColourRange(float minr, float maxr, float ming, float maxg, float minb, float maxb) {
