...
public class EFXFilterLowPass extends EFXFilter {
	...
	/** Returns the gain of the low-pass filter.
	 * @return The float value of the gain
	 */
	public float getGain() {
		return getFilter(EFX10.AL_LOWPASS_GAIN);
	}
	
	/** Returns the gain of the low-pass filter's high frequencies.
	 * @return The float value of the high frequency gain
	 */
	public float getGainHF() {
		return getFilter(EFX10.AL_LOWPASS_GAINHF);
	}
}