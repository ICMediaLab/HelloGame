...
public abstract class EFXFilter {
	...
	/** Returns the current value of an filter property.
	 * @param passedProperty The property we want the value for
	 * @return The float value of the filter property
	 */
	protected float getFilter(int passedProperty) {
		return EFX10.alGetFilterf(filterIndex, passedProperty);
	}
}