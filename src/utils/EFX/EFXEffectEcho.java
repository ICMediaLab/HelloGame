...
public class EFXEffectEcho extends EFXEffect {
	...
	public float getDamping() {
		return getEffectf(EFX10.AL_ECHO_DAMPING);
	}
	...
	public float getDelay() {
		return getEffectf(EFX10.AL_ECHO_DELAY);
	}
	...
	public float getFeedback() {
		return getEffectf(EFX10.AL_ECHO_FEEDBACK);
	}
	...
	public float getLRDelay() {
		return getEffectf(EFX10.AL_ECHO_LRDELAY);
	}
	...
	public float getSpread() {
		return getEffectf(EFX10.AL_ECHO_SPREAD);
	}
}