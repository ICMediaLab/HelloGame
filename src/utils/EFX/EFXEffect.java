...
public abstract class EFXEffect {
	 ...
	 * @param passedProperty The property we want the value for
	 * @return The float value of the effect property
	 */
	protected float getEffectf(int passedProperty) {
		return EFX10.alGetEffectf(effectIndex, passedProperty);
	}
	
	/** Returns the current value of an effect property.
	 * @param passedProperty The property we want the value for
	 * @return The int value of the effect property
	 */
	protected int getEffecti(int passedProperty) {
		return EFX10.alGetEffecti(effectIndex, passedProperty);
	}
}